...
/* ---------- declares variables to store weather condition codes ---------- */
// I prepared this list, but I would have preferred that it was provided for us in case it is wrong
...
var getCityWeather = function (citySearchTerm) {
  /* calls function to reset some values
  refer to function */
  resets();
...
var displayCurrentWeather = function (data) {
  ...
  /* ---------- gets weather values from fetched data ---------- */
  ...
  // calls function to decide bg color of UV Index depending on currentWeatherCondition code
...
/* ---------- writes uv index value from fetch reponse to html ---------- */
...
/* ---------- writes weather forecast data from fetch reponse to html ---------- */
